...
This mechanism has been integrated into Bitcore-Node-Aywa which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/aywapay/insight-api-aywa#web-socket-api](https://github.com/aywapay/insight-api-aywa#web-socket-api)
* API: [https://github.com/aywapay/insight-api-aywa#instantsend-transactions](https://github.com/aywapay/insight-api-aywa#instantsend-transactions)
...
By default, the Aywa Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Aywa Core daemon:
