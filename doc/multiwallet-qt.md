...
Only requiring some minor changes is aywa.cpp.
...
Changes to aywa.cpp
----------------------
aywa.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
