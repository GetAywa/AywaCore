...
### Send 1000 AYWA to New Addresses

Send exactly 1000 AYWA to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1000 AYWA.

*Note: The masternode priviate key is **not** the same as a wallet private key. **Never** put your wallet private key in the masternode.conf file. That is almost equivalent to putting your 1000 AYWA on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the aywa github repo](https://github.com/aywapay/aywa/blob/master/doc/masternode_conf.md)
...
## Update aywa.conf on server

If you generated a new masternode private key, you will need to update the remote `aywa.conf` files.
...
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `aywa.conf` file.
...
and comparing with the official explorer at https://explorer.aywa.org/chain/Aywa
...
Search your Masternodes on https://aywaninja.pl/masternodes.html
