...
bool static AlreadyHave(const CInv& inv) EXCLUSIVE_LOCKS_REQUIRED(cs_main)
{
    ...
    /* 
        Aywa Related Inventory Messages
...
//       else if ((strCommand == "smsgPing")||(strCommand=="smsgPong")||(strCommand=="smsgDisabled")||(strCommand=="smsgShow")||
//                (strCommand=="smsgMatch")||(strCommand=="smsgHave")||(strCommand=="smsgWant")||(strCommand=="smsgMsg")||(strCommand=="smsgInv"))
    ...
    else
    {
        ...
        if (found)
        {
            ...
            if ((strCommand == "smsgPing")||(strCommand=="smsgPong")||(strCommand=="smsgDisabled")||(strCommand=="smsgShow")||
                            (strCommand=="smsgMatch")||(strCommand=="smsgHave")||(strCommand=="smsgWant")||(strCommand=="smsgMsg")||(strCommand=="smsgInv"))
                {if (fSecMsgEnabled)
                            SecureMsgReceiveData(pfrom, strCommand, vRecv, connman);
                 return true;
                }
...
bool SendMessages(CNode* pto, CConnman& connman, std::atomic<bool>& interruptMsgProc)
{
    ...
    const Consensus::Params& consensusParams = chainParams.GetConsensus();
    {
        ...
        if (fSecMsgEnabled)
              SecureMsgSendData(pto, connman); // should be in cs_main?
