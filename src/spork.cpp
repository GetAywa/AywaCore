...
{
    if(fLiteMode) return; // disable all Aywa specific functionality
...
bool CSporkManager::IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        switch (nSporkID) {
            ...
            //case SPORK_A015_PROPOSAL_MIN_COST_VALUE:            r = SPORK_A015_PROPOSAL_MIN_COST_VALUE_DEFAULT; break;
            //case  SPORK_A016_SYNCBLOCKTIME_FLAG:            r = SPORK_A016_SYNCBLOCKTIME_FLAG_DEFAULT; break;
            case SPORK_A017_ANY_MASTERNODE_PORT_ENABLED:    r = SPORK_A017_ANY_MASTERNODE_PORT_ENABLED_DEFAULT; break;
            default:
...
int64_t CSporkManager::GetSporkValue(int nSporkID)
{
    ...
    switch (nSporkID) {
        ...
        //case SPORK_A015_PROPOSAL_MIN_COST_VALUE:        return SPORK_A015_PROPOSAL_MIN_COST_VALUE_DEFAULT;
        //case SPORK_A016_SYNCBLOCKTIME_FLAG:             return SPORK_A016_SYNCBLOCKTIME_FLAG_DEFAULT;
         case SPORK_A017_ANY_MASTERNODE_PORT_ENABLED:   return SPORK_A017_ANY_MASTERNODE_PORT_ENABLED_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    //if (strName == "SPORK_A015_PROPOSAL_COST_VALUE")            return SPORK_A015_PROPOSAL_MIN_COST_VALUE;
    //if (strName == "SPORK_A016_SYNCBLOCKTIME_FLAG")             return SPORK_A016_SYNCBLOCKTIME_FLAG;
    if (strName == "SPORK_A017_ANY_MASTERNODE_PORT_ENABLED")    return SPORK_A017_ANY_MASTERNODE_PORT_ENABLED;
...
std::string CSporkManager::GetSporkNameByID(int nSporkID)
{
    switch (nSporkID) {
        ...
        //case SPORK_A015_PROPOSAL_MIN_COST_VALUE:            return "SPORK_A015_PROPOSAL_COST_VALUE";
        //case SPORK_A016_SYNCBLOCKTIME_FLAG:             return "SPORK_A016_SYNCBLOCKTIME_FLAG";
        case SPORK_A017_ANY_MASTERNODE_PORT_ENABLED:    return "SPORK_A017_ANY_MASTERNODE_PORT_ENABLED";
        default:
