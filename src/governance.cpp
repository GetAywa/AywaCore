...
int CGovernanceManager::Count(const int nProposalType) const //proposal count - GOVERNANCE_OBJECT_PROPOSAL
{
    LOCK(cs);
    ...
    switch (nProposalType) {
    case GOVERNANCE_OBJECT_PROPOSAL:
        return nProposalCount;
    case GOVERNANCE_OBJECT_TRIGGER:
        return nTriggerCount;
    case GOVERNANCE_OBJECT_WATCHDOG:
        return nWatchdogCount;
    default:
        return nOtherCount;
    }
    return 0;
