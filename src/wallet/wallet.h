...
enum WalletFeature
{
    FEATURE_BASE = 10101,//10500, // the earliest version new wallets supports (only useful for getinfo's clientversion output)

    FEATURE_WALLETCRYPT = 40000, // wallet encryption
    FEATURE_COMPRPUBKEY = 10101,//60000, // compressed public keys
    FEATURE_HD = 10101,//120200,    // Hierarchical key derivation after BIP32 (HD Wallet), BIP44 (multi-coin), BIP39 (mnemonic)
                            // which uses on-the-fly private key derivation

    FEATURE_LATEST = 10101//61000
};
...
enum AvailableCoinsType
{
    ...
    ONLY_DENOMINATED,
    ONLY_NONDENOMINATED,
    ONLY_MN_COLLATERAL, //ONLY_1000, // find masternode outputs including locked ones (use with caution)
...
public:
    ...
    /// Get 1000AYWA output and keys which can be used for the Masternode
