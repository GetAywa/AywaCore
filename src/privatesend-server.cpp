...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Aywa related functionality
...
/*
    ...
    allow endless transaction that would bloat Aywa and make it unusable. To
