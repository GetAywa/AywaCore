 ...
 *
 *   // network
 *   CAywaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.aywa.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAywaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AywaNetwork
// //   -- signature requirements : Key1(User)
// class CAywaNetworkVariable : public CGovernanceObject
// {
// private:
