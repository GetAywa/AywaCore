    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Aywa Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Aywa Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  aywa-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Aywa Core is shutting down...") + "<br /><br />" +
