    ...
    type(type)
{
    ...
    if(mode == SendMessagesDialog::Encrypted)
        ui->addressFrom->setPlaceholderText(tr("Enter your AYWA address (e.g. A8gZqgY4r2RoEdqYk3YsAqFckyf9pRHN6i)"));
 #endif
    addEntry();
...
void SendMessagesDialog::on_checkBox_stateChanged(int arg1)
{
   arg1 ? ui->addressFrom->setText("anon") : ui->addressFrom->setText("");
   ui->addressFrom->setEnabled(!arg1);
   ui->addressBookButton->setEnabled(!arg1);
   ui->pasteButton->setEnabled(!arg1);
}
