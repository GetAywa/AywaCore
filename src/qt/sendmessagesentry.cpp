    ...
    model(0)
{
    ...
    ui->sendTo->setPlaceholderText(tr("Enter a Bitcoin Lightning address (e.g. B8gZqgY4r2RoEdqYk3YsAqFckyf9pRHN6i)"));
...
bool SendMessagesEntry::validate()
{
    ...
    if(ui->publicKey->text() == "" && !GetIsChannelSubscribed(ui->sendTo->text().toStdString()))
    {
