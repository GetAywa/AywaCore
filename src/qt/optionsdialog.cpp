    ...
    mapper(0)
{
    ...
    /* Theme selector */
//    ui->theme->addItem(QString("AYWA-light"), QVariant("light"));
//    ui->theme->addItem(QString("AYWA-light-hires"), QVariant("light-hires"));
//    ui->theme->addItem(QString("AYWA-blue"), QVariant("drkblue"));
//    ui->theme->addItem(QString("AYWA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("AYWA-traditional"), QVariant("trad"));
