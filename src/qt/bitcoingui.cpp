    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Aywa Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Aywa address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and aywa: URIs)"));
    ...
    messageAction = new QAction(QIcon(":/icons/" + theme + "/messages"), tr("&Messages"), this);
    messageAction->setStatusTip(tr("Secure messaging"));
    messageAction->setToolTip(messageAction->statusTip());
    messageAction->setCheckable(true);
#ifdef Q_OS_MAC
    messageAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_5));
#else
    messageAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
#endif
    ...
    if (settings.value("fShowMasternodesTab").toBool()) {
        masternodeAction = new QAction(QIcon(":/icons/" + theme + "/masternodes"), tr("&Governance"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Aywa Core"), this);
    aboutAction->setStatusTip(tr("Show information about Aywa Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Aywa Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Aywa addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Aywa addresses"));
    ...
    openAction->setStatusTip(tr("Open a aywa: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Aywa Core help message to get a list with possible Aywa Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Aywa Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Aywa network", "", count));
    } else {
...
{
    QString strTitle = tr("Aywa Core"); // default title
