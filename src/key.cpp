...
//    pkey = NULL;
//    Reset();
//    size_t clen = vchPubKey.vchPubKey.size();
//    secp256k1_pubkey pubkey = vchPubKey;
//    return secp256k1_ec_pubkey_serialize(secp256k1_context_sign, (unsigned char*)pbegin, &clen, pubkey, fCompressed ? SECP256K1_EC_COMPRESSED : SECP256K1_EC_UNCOMPRESSED);
//}
